//
//  TYWJScanQRcodeViewController.m
//  TYWJBus
//
...
@interface TYWJScanQRcodeViewController ()<UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@property (nonatomic, strong)  WSLNativeScanTool * scanTool;
@property (nonatomic, strong)  WSLScanView * scanView;
@end

@implementation TYWJScanQRcodeViewController
- (void)viewDidLoad {
    [super viewDidLoad];
