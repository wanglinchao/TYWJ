...
@interface TYWJMyRouteController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TYWJMyRouteController
...
- (void)loadData {
    switch (self.type) {
        case TYWJMyRouteControllerTypeSingleTicket:
        {
            [self loadSingleTicketData];
        }
            break;
        case TYWJMyRouteControllerTypeMonthTicket:
        {
            [self loadPeriodTicketData];
        }
            break;
        case TYWJMyRouteControllerTypeCommute:
        {
            [self loadPeriodTicketData];
        }
            break;
